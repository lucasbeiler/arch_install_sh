...
* **Full Disk Encryption with LUKS:**
  ...
  - A TPM PIN is also enabled. If the correct PIN is not entered, communication with the TPM does not even begin;
    - This PIN is limited to a maximum of 4 failed attempts every 24 hours to drastically slow down bruteforce and dictionary attacks. This throttling turns even a short, random PIN into something difficult to crack (if we pretend that the TPM is always reliable and has no vulnerabilities, which is not always true).

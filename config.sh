...
LINUX_FIRMWARE_PACKAGES="linux-firmware-intel"
...
# Core.
PACSTRAP_PACKAGES="base ${BASE_DEVEL_WITHOUT_SUDO} ${KERNEL} ${KERNEL}-headers ${CPU_VENDOR}-ucode man-db iwd bcachefs-tools btrfs-progs ntpd-rs sbsigntools opendoas apparmor dracut binutils elfutils tpm2-tools sbctl ${LINUX_FIRMWARE_PACKAGES}"

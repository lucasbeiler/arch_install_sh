...
git clone https://github.com/GrapheneOS/hardened_malloc && cd hardened_malloc && make && mv out/libhardened_malloc.so /mnt/usr/local/lib/ && chmod 755 /mnt/usr/local/lib/libhardened_malloc.so && cd -
